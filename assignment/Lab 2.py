...
class Pantry:
    ...
    def stock_pantry(self, item, qty):  # function to add an item to the quantity
        # --- YOUR CODE STARTS HERE
    ...
    def transfer(self, other_pantry, item):  # transfers stock from other pantry
        # --- YOUR CODE STARTS HERE
        if item in other_pantry.items:
            ...
            print(f"{other_pantry} doesn't have {item}")
